                ...
                <div class="cards">
                    ...
                    @foreach($lunghe as $card)
                        <div class="card">
                            ...
                            <div class="hover">
                                <h2>{{$card['titolo']}}</h2>
                                <svg class="mk-svg-icon" data-name="mk-li-food" data-cacheid="icon-5eabe39c707e5" style=" height:20px; width: 20px; " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
